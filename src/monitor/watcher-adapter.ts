...
export async function createFileWatcher(paths: string | string[], options?: WatcherOptions): Promise<WatcherAdapter> {
  if (USE_FS_WATCH) {
    ...
    return {
      ...
      // biome-ignore lint/suspicious/noExplicitAny: Chokidar's EventEmitter type is complex
